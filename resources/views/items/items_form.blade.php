        ...
        @if (isset($item))
            <form  action="{{ route('items.update', ['id'=> $item->id]) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <input type="file" class="form-control form-control-file" name="image" id="image" aria-describedby="fileHelpId">
                ...
                <button type="submit" class="btn btn-primary m-2">Accept</button>
                <a href="/items" class="btn btn-secondary m-2">Cancel</a>
            </form>
        @else
